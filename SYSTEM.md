...
- 텔레그램 포럼 그룹 「부산 통합 모니터링」(chat_id `-1004297621610`) 하나에 주제(방) 23개로 전부 배달.
...
3. 분야방 발송 후 추가 발송: 단독·속보방, 인터뷰/르포방, 시당위원장방(맥락 단락 `…ctx…` 포함 동일 형식). **분야방 '대신' 전용 방에만 가는 예외**(아카이브 분야 태그는 유지): 시의회(8/23) · 기고·칼럼(8/24) · **사회 세분화(8/26): 사회 기사 중 사건·사고(socialSub, 🚨)와 날씨·재난(🌦)은 각 방으로만** — 사회방 285건/일 중 사건 70·재난 58건이 분리, 사회방엔 ~155건/일 남음.
